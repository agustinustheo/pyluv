...
import re
import pickle
from pyluv.settings import API_PICKLE_ROOT
from django.http import HttpResponse
from nltk.tokenize import word_tokenize
PICKLE_FOLDER = os.path.join(API_PICKLE_ROOT, 'sms_classifier_pickle')

def classify_text(request):
    to_be_classified = request.GET.get('sms_text')
    ...
    def convertAlay(text):
        ...
        for msg in words:
            ...
            if alpha_flag and digit_flag:
                msg = msg.lower()
                if msg[-4:] != 'ribu' and msg[-3:] != 'rbu' and msg[-2:] != 'rb' and msg[-4:] != 'juta' and msg[-3:] != 'jta' and msg[-2:] != 'jt':
                    for c in msg:
                        if c == '1':
                            c = 'i'
                        elif c == '2':
